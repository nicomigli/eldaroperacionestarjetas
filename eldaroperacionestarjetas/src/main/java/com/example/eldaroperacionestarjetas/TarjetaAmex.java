...
public class TarjetaAmex extends Tarjeta {
    ...
    public TarjetaAmex(int idTarjeta,String marca, long numeroTarjeta, Persona persona, LocalDate fechaVencimiento) {
    ...
    public HashMap<String,BigDecimal> tasa() throws Exception {
        ...
        put(marca,BigDecimal.valueOf(month).multiply(BigDecimal.valueOf(0.1)));
    }} ;  
    }
